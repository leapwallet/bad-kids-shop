...
export function ListControl({
  ...
  return (
    <section className=" w-[90vw] gap-3 flex-row flex flex-wrap justify-between sm:!p-6">
      ...
      <div className="flex items-center ml-auto flex-wrap gap-3 justify-center bg-gray-950 px-4 py-2 rounded-3xl text-white-100 ">
        <MdSort color="#FFF" />
        <select
          value={sortOrder}
          onChange={(event) =>
